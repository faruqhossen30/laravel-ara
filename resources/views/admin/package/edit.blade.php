            ...
            <div class="card-body">
                <form action="{{route('package.store')}}" method="POST" enctype="multipart/form-data" class="forms-sample">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" value="{{$package->name}}" class="form-control" id="forName" autocomplete="off" placeholder="Name">
                    </div>
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="type" class="form-select form-select-sm mb-3">
                                ...
                                <option value="install" @if($package->type == 'install') selected @endif>Install</option>
                                <option value="review"  @if($package->type == 'review') selected @endif>Review</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="forPrice" class="form-label">Price</label>
                            <input type="number" name="price" value="{{$package->price}}" class="form-control" id="forPrice" autocomplete="off" placeholder="Price">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group" id="simple-list">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between ">{{$service->service}}
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click', '#addButton', function(){
            ...
            $('#simple-list').append(`
            <li class="list-group-item d-flex justify-content-between">${service}
