...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data" class="forms-sample">
                    @csrf
                    @method('put')
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{$blog->title}}" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Title" name="title">
                                    </div>
                                    {{-- Description start --}}
                                    <div class="row">
                                        <div class="col-md-12 grid-margin stretch-card">
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" value="{{$blog->meta_title}}" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Title" name="meta_title">
                                            </div>
                                            {{-- meta description --}}
                                            <div class="mb-3">
                                                <label for="exampleInputUsername1" class="form-label"> Meta Description</label>
                                                <textarea name="meta_description" id="meta_description" cols="30" rows="10" class="form-control">{{ $blog->meta_description }}</textarea>
                                            </div>
                                            {{-- Tag input --}}
                                            <div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-check mb-2">
                                                <input name="category_id[]" value="{{ $category->id }}" type="checkbox" @if(empty(!json_decode($blog->category_id)) && in_array($category->id, json_decode($blog->category_id))) checked @endif
